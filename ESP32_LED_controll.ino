...
#define led_pin_3 17 // data pin used to send control signal to third led strip
...
// if(LEDstrip1 == true){
   if(gCurrentPatternNumber1 > 7){
    gCurrentPatternNumber1 = 1;
     ...
     Serial.println("GCurrentPatternNumber1: " + gCurrentPatternNumber1);
     Serial.println(gCurrentPatternNumber1);
...
// if(LEDstrip2 == true){
   if(gCurrentPatternNumber2 > 7){
     ...
     Serial.println("GCurrentPatternNumber2:");
     Serial.println(gCurrentPatternNumber2);
   } 
// }
}
